...
export const themes = {
  soft: {
    ...
    card: 'bg-white/80 backdrop-blur-sm border border-pink-100/80 shadow-lg shadow-pink-100/40',
  ...
  sharp: {
    ...
    // Backgrounds
    bg: 'bg-[#06080d]',
    card: 'bg-white/[0.04] backdrop-blur-xl border border-white/[0.07] shadow-2xl',
    cardHover: 'hover:bg-white/[0.07] hover:border-cyan-500/25 hover:shadow-cyan-500/10 hover:shadow-2xl transition-all duration-200',
    // Primary
    ...
    // Buttons
    button: 'bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-lg shadow-cyan-900/40 hover:shadow-cyan-800/60 hover:scale-105',
    ...
    // Misc
    gameCard: 'bg-white/[0.04] border border-cyan-900/30',
    inputBg: 'bg-white/[0.06] border-white/[0.08] focus:border-cyan-500 focus:ring-cyan-900',
    motivational: [
      'Концентрирай се.',
      'Без оправдания.',
